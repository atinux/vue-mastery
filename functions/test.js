...
//     params: {
//       cid: '1516789793545',
//       uid: 'KWuKWA7WpledvvvwrCDL6lFYKbT2'
//     }
//   }
// )
...
describe('Cloud Functions', () => {
  ...
  describe('subscribeUserToCourse', () => {
    // Test Case: adding a user should send a confirmation email
    it('Should send an email', () => {
      ...
      const fakeEvent = {
        ...
        data: new functions.database.DeltaSnapshot(null, null, null, '/accounts/{uid}')
  ...
  // Test Case: adding a lesson to the list should cause 'lessonsCount' to increase by one
  describe('countLessonsInCourse', () => {
    it('should return a 303 redirect', (done) => {
      // [START stubAdminDatabase]
      const refParam = '/flamelink/environments/production/content/courses/en-US/{cid}/lessons/{lid}'
